...
from .Panel import VIEW3D_PT_NendoViewport, PIE_MT_Floating_Menu, VIEW3D_PT_gizmo_panel
...
__classes__ = (
  ...
  VIEW3D_OT_DecreaseMultires, PIE_MT_Floating_Menu, VIEW3D_OT_MenuController, VIEW3D_PT_gizmo_panel
)
ov = Overlay()
